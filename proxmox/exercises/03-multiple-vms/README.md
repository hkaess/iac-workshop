...
4. Sorge dafuer, dass alle 3 VMs eindeutige VM-IDs bekommen (z.B. fortlaufend ausgehend von der bisherigen VM-ID).
5. Achte darauf, dass die Namen auch bei allen parallelen Teilnehmenden eindeutig bleiben.
6. Gib die erzeugten VM-Namen und VM-IDs am Ende als Outputs sinnvoll aus.
