...
4. Fuege der VM eine zweite Disk mit `50 GB` fuer Daten hinzu (eigener `disk`-Block mit `unit_number = 1`).
...
- Die zweite Disk mit 50 GB ist als eigener `disk`-Block modelliert.
